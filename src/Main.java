...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Выберите номер задание:\n" +
                ...
                "2. Средняя арифметическая отрицательных чисел и неотреательных (в конце введите 1000)\n" +
    ...
    public static void zad2(){
        ...
        float otchs = 0;
        int ot = 0;
        System.out.print("Дальше просто вводите числа (напоминание: в конце введите 1000): ");
        while(true){
            ch = input.nextFloat();
            if (ch==1000){
                break;
